...
class GenerateBlocks_Pro_Condition_User_Meta extends GenerateBlocks_Pro_Condition_Abstract {
	...
	public function get_operators_for_rule( $rule ) {
		...
		if ( $this->rule_supports_multi_select( $rule ) ) {
			return [ 'exists', 'not_exists', 'equals', 'contains', 'not_contains', 'greater_than', 'less_than', 'includes_any', 'includes_all', 'excludes_any', 'excludes_all' ];
		} else {
			return [ 'exists', 'not_exists', 'equals', 'contains', 'not_contains', 'greater_than', 'less_than' ];
		}
	}
}
